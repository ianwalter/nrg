...
module.exports = {
  ...
  get baseUrl () {
    return process.env.NRG_BASE_URL ||
      // FIXME: simplify with @ianwalter.url
  ...
  get accounts () {
    ...
    return {
      get enabled () {
        return this.dummyPassword && this.dummyPassword !== 'ijFu54r6PyNdrNLj9y'
      },
      dummyPassword: 'ijFu54r6PyNdrNLj9y',
  ...
  get validators () {
    const { Account } = this.accounts.models
    const email = { isEmail }
