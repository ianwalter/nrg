...
function generateDefaults (options) {
  ...
  return {
    ...
    db: {
      ...
      migrations: options.db && options.db.migrations
        ? typeof options.db.migrations === 'string'
          ? { directory: options.db.migrations }
          : options.db.migrations
        : {},
      seeds: options.db && options.db.seeds
        ? typeof options.db.seeds === 'string'
          ? { directory: options.db.seeds }
          : options.db.seeds
        : {}
    },
