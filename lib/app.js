...
module.exports = function createApp (options = {}) {
  ...
  // Update the mailgen defaults to use the application name and url if defined.
  if (options.name) {
    defaults.email.mailgen.product.name = options.name
  }
  if (options.baseUrl) {
    defaults.email.mailgen.product.link = options.baseUrl
  }
