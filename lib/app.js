...
module.exports = function createApp (options = {}) {
  const hasNotPassedBaseUrl = !options.baseUrl
  ...
  app.logger = options.log
    ? options.logger || pino(options.log)
    : new Print({ level: 'error' })
  ...
  if (hasNotPassedBaseUrl && options.isNotDev) {
