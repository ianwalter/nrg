...
module.exports = function config (options = {}) {
  const cfg = {
    ...
    redis: {
      get enabled () {
        return cfg.keys?.length || Object.values(this.connection).some(v => v)
      },
      connection: {
    ...
    db: {
      get enabled () {
        return Object.values(this.connection).some(v => v) || options.db
      },
      client: 'pg',
      connection: {
